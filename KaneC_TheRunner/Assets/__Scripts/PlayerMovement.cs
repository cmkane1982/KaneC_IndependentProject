...
public class PlayerMovement : MonoBehaviour
{
    ...
    [Header("Powerups")]
    public LayerMask dashPowerup;
    public LayerMask jumpPowerup;
    ...
    private void MyInput()
    {
        ...
        if(Input.GetKey(jumpKey) && state == MovementState.air && numJumps > 0 && state != MovementState.wallrunning)
        {
    ...
    public void CollectPowerup(LayerMask powerup)
    {
        ...
        else if(powerup == jumpPowerup && numJumps < maxNumJumps)
        {
            numJumps++;
        }
    }
